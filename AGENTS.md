...
- **8 CDK stacks**
- **410 tests** (316 backend unit + 41 regression + 53 frontend) + on-demand prompt regression harness (deterministic V1 + managed AgentCore Evaluations V2)
...
│
├── tests/                      # Test suite
│   ├── unit/                           # Lambda unit tests (316 tests)
...
**Lambda Unit Tests (316 tests, ~2s):**
```bash
pytest tests/unit/ -v
```
