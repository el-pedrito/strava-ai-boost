...
- **8 CDK stacks**
- **400 tests** (306 backend unit + 41 regression + 53 frontend) + on-demand prompt regression harness (deterministic V1 + managed AgentCore Evaluations V2)
...
│
├── tests/                      # Test suite
│   ├── unit/                           # Lambda unit tests (306 tests)
...
**Lambda Unit Tests (306 tests, ~2s):**
```bash
pytest tests/unit/ -v
```
