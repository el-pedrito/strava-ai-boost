...
- **8 CDK stacks**
- **396 tests** (302 backend unit + 41 regression + 53 frontend) + on-demand prompt regression harness (deterministic V1 + managed AgentCore Evaluations V2)
...
│
├── tests/                      # Test suite
│   ├── unit/                           # Lambda unit tests (302 tests)
...
**Lambda Unit Tests (302 tests, ~2s):**
```bash
pytest tests/unit/ -v
```
