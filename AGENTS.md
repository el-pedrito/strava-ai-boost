...
- **8 CDK stacks**
- **666 tests** (570 backend unit + 43 regression + 53 frontend) + on-demand prompt regression harness (deterministic V1 + managed AgentCore Evaluations V2)
...
│
├── tests/                      # Test suite
│   ├── unit/                           # Lambda unit tests (570 tests)
...
**Lambda Unit Tests (570 tests, ~2s):**
```bash
pytest tests/unit/ -v
```
