...
- **8 CDK stacks**
- **335 tests** (250 backend unit + 41 regression + 44 frontend) + on-demand prompt regression harness (deterministic V1 + managed AgentCore Evaluations V2)
...
│
├── tests/                      # Test suite
│   ├── unit/                           # Lambda unit tests (250 tests)
...
**Lambda Unit Tests (250 tests, ~2s):**
```bash
pytest tests/unit/ -v
```
