...
Use workout_phases and route_landmarks as the backbone of a mini-narrative. The athlete's session has a beginning, a middle, and an end — tell that story.
...
2. **Rising action** — The effort builds through workout phases
   - Map workout_phases to story progression: warm-up = "mise en jambes", steady state = "j'ai trouvé mon rythme", intervals = "le vrai travail commence"
...
The user gave almost nothing — infer sensations from data (FC stable, pace regular, workout_phases).
