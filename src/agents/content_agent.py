...
SÉANCE RENFO / PPG : nomme les exercices d'après le champ "name" de chaque exercice de campus_coach_session (ex. "Extension de Mollet", "Gainage Frontal", "Mollet statique", "Gainage Latéral", "Split Squat", "Bond sur place", "Swing avec charge"), avec leurs "reps"/"duration" quand ils existent ; les synonymes courants sont admis (une "fente" = un "Split Squat"). Les CHARGES (kg) ne sont PAS dans Campus : reprends-les UNIQUEMENT depuis la description de l'athlète, fidèlement, sans les transformer (ex. "split squat avec 2 kettlebells de 20kg", "mollets kettlebell 12kg", "swing kettlebell 24kg"). Ne confonds JAMAIS une charge avec un nombre de répétitions : "2 kettlebells de 20kg" n'est PAS "20 fentes". N'ajoute aucune variante que l'athlète n'a pas écrite ("bulgare"). Si l'athlète ne donne pas de charge pour un exercice, n'en invente pas.
