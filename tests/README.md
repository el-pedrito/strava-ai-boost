...
> - `tests/unit/` — 544 mocked Lambda unit tests, no AWS credentials (`pytest tests/unit/`)
...
Done since this suite was written: **Lambda unit tests** (544 mocked tests in `tests/unit/`) and **agent prompt tests** (regression harness in `tests/regression/` + live V1/V2 runners). Remaining ideas:
