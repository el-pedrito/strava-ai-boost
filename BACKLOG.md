...
- 613 tests (517 backend unit + 43 régression + 53 frontend) + 73 tests d'intégration
...
- **Cost optimization pass (April 2026)** — $517/mo -> ~$26/mo (Campus Coach cron + Haiku, Bedrock prompt caching, MaxToolCountsHook, MonitoringStack supprimé).
