...
```bash
# Lambda unit tests (249 tests, ~2s — no AWS credentials needed)
pytest tests/unit/ -v
...
**Test coverage:** 334 total tests (249 backend unit + 41 regression + 44 frontend), plus integration tests.
