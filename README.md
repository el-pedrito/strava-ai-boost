...
```bash
# Lambda unit tests (544 tests, ~2s — no AWS credentials needed)
pytest tests/unit/ -v
...
**Test coverage:** 640 total tests (544 backend unit + 43 regression + 53 frontend), plus integration tests.
