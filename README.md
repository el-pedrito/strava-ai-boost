...
```bash
# Lambda unit tests (306 tests, ~2s — no AWS credentials needed)
pytest tests/unit/ -v
...
**Test coverage:** 400 total tests (306 backend unit + 41 regression + 53 frontend), plus integration tests.
