...
```bash
# Lambda unit tests (302 tests, ~2s — no AWS credentials needed)
pytest tests/unit/ -v
...
**Test coverage:** 396 total tests (302 backend unit + 41 regression + 53 frontend), plus integration tests.
