...
```bash
# Lambda unit tests (316 tests, ~2s — no AWS credentials needed)
pytest tests/unit/ -v
...
**Test coverage:** 410 total tests (316 backend unit + 41 regression + 53 frontend), plus integration tests.
