...
> Compte AWS : 923561819387 (profil `pibenard+ai-Admin`, us-east-1)
...
**Roles tagués** :
```
AmazonBedrockAgentCoreSDKRuntime-us-east-1-1ac83344c7 → agent=campus_coach
AmazonBedrockAgentCoreSDKRuntime-us-east-1-32fcd9cc2b → agent=content_gen
```
