...
**Source**: https://www.cdc.gov/sleep/about/
...
Les 87 clés `metrics.*` (labels, titres, définitions et calculs des 14 métriques ci-dessus) sont implémentées dans `frontend/src/i18n/{en,fr}.json` — source de vérité unique, ne pas dupliquer ici.
